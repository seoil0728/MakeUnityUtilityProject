...
## 8. SettingManager (`SWUtility.Setting`)
Key-Value 기반의 이벤트 브로드캐스팅 방식을 사용하여 결합도 없이 게임 설정을 통합 관리하고 로컬 JSON 파일로 영구 저장하는 시스템입니다.
👉 **상세 메뉴얼:** [Manual_SettingManager.md](Manual_SettingManager.md)
